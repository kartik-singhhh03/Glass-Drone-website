  ...
  return (
    ...
    >
      <div className="max-w-[1240px] mx-auto px-6">
        ...
        {/* Cards */}
        <div className="services-section flex flex-col gap-[70px] md:gap-[100px]">
          {services.map((service, index) => {
            ...
            return (
              <div key={index} className="service-card group">
                ...
                >
                  {/* Image */}
                  <div className="w-full md:w-[50%] h-[260px] sm:h-[340px] md:h-[420px] relative overflow-hidden bg-gray-900 flex-shrink-0">
                    <img
                      src={service.image}
                  ...
                  {/* Content */}
                  <div className="service-content w-full md:w-[50%] flex flex-col justify-center px-9 py-10 md:px-12 md:py-14">
                    {/* Accent line */}
                    ...
                    <div className="flex items-start gap-3 bg-[#F0FAFB] border border-blue-accent/15 rounded-[16px] p-4 mb-8">
                      <Focus
                        className="text-blue-accent flex-shrink-0 mt-0.5"
                        size={20}
                      />
                      <div>
                    ...
                    >
                      <span className="mr-3 font-semibold text-[14px]">
                        {t("nav.Get a Quote")}
                      </span>
                      <ArrowRight
                        size={17}
